...
class WPM_Admin_Menus {
	...
	public function settings_menu() {
		$settings_page = add_menu_page( __( 'WP Multilang Settings', 'wp-multilang' ), __( 'WP Multilang', 'wp-multilang' ), 'manage_options', 'wpm-settings', array( $this, 'settings_page' ), 'dashicons-translation' );
