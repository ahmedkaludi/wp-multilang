...
$main_params = array(
    ...
    'allow_auto_override'               => get_option( 'wpm_allow_auto_override', 'no' ),
    'confirmation_message'              => esc_html__( 'This will initiate the translation process. Any existing translation for this language will be overwritten. Would you like to proceed?', 'wp-multilang' ),
